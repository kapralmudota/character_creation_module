...
"""This is the module responsible for creating a character."""


def attack(char_name: str, char_class: str) -> str:
    """Do function describing the logic of the attack."""
    ...
    if char_class == 'healer':
        return (
            f'{char_name} нанёс урон противнику равный '
            f'{5 + randint(-3, -1)}')
    return f'{char_name} не стал наносить урон противнику.'


def defence(char_name: str, char_class: str) -> str:
    """Do function describing the logic of the defence."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Do function describing the logic of the special skill."""
    if char_class == 'warrior':
